...
router.post("/putData", (req, res) => {
  ...
  const { author, author_id, title, type, reward, description, thumbnail, image, code } = req.body;
  ...
  request.post("https://auth.viarezo.fr/oauth/token", {form: requestBody}, (err, response, body)=>{
                  ...
                  if (data.error) {
                    ...
                    .then(response => {console.log(response.data);
                      ...
                      data.author = response.data.firstName + response.data.lastName;
                      data.author_id = response.data.id;
