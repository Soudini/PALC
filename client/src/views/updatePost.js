...
class CreatePost extends Component {
  ...
  getDataFromDb = () => {
    fetch("localhost:3001/api/getData")
      .then(data => data.json())
  ...
  handleSubmit =()=> {
      ...
      axios.post("localhost:3001/api/updateData", {id :this.props.match.params.id, update : {
  ...
  searchDataFromDb = () => {
    ...
    axios.post("localhost:3001/api/searchById", {id :this.props.match.params.id, auth : cookies.get("auth")})
