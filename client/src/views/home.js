          ...
          <div className="row">
            <div className="col-lg-6 mx-auto text-center">
              ...
              <p> Mais qu'est ce que PALC peut bien vouloir dire ?  Ca veut dire "Pinte à la clé" ! Tu peux trouver ici les objets trouvés, ou faire une annonce si tu as trouvé un objet.<br />
                Ce site est en période de test, si vous rencontrez un problème ou avez une remarque, n'hésitez pas à envoyer à mail à <a id="mail_contact" href="mailto:palc@ml.viarezo.fr">palc@ml.viarezo.fr</a></p>
            </div>
          </div>
        </div>
      </section>
