      ...
      <nav className="navbar fixed-top navbar-expand-lg navbar-dark bg-dark col-lg-12">
        ...
        <div className="collapse navbar-collapse" id="navbar">
          <ul className="navbar-nav mr-auto">
            <li className={"nav-item" + this.props.history[this.props.history.length -1] == "/search" ? " active":""}>
              <a className="nav-link hover-pointer" onClick={() => this.handlePageChange("search")}>Recherche <span className="sr-only">(current)</span></a>
            </li>
            <li className={"nav-item" + this.props.history[this.props.history.length -1] == "/found" ? " active":""}>
              <a className="nav-link hover-pointer" onClick={() => this.handlePageChange("found")}>Trouvaille <span className="sr-only">(current)</span></a>
            </li>
            <li className={"nav-item" + this.props.history[this.props.history.length -1] == "/createPost" ? " active":""}>
            ...
            <li className={"nav-item" + this.props.history[this.props.history.length -1] == "/perso" ? " active":""}>
