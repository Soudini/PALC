          ...
          <div className="cntr">
            <div className="cntr-innr">
              <label className="search" for="inpt_search"  >
                <input id="inpt_search" type="text" onKeyPress={this.handleKeyPress} aria-label="Search" onChange={this.handleSearchText} onClick={() => this.handlePageChange("searchEngine/" + this.state.search)} />
              </label>
            </div>
          </div>
        </div>
