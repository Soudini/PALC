  ...
  render() {
    return (
      <nav className="navbar fixed-top navbar-expand-xl navbar-dark col-lg-12">
        <a className="navbar-brand" href="" onClick={() => this.handlePageChange("")}><img src={logopalc} id="logo_navbar" class="d-inline-block align-top" alt="Responsive image" />PALC</a>
