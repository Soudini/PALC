...
export class Page extends Component { // full page view of the ad with the id written in the URI
  ...
  render() {
    ...
    if (this.state.data && this.state.show_button) { // if we have some data and have to show the button
      ...
      buttonUpdate = <button className="btn btn-primary col" style={{ "marginRight": "1rem", "marginLeft": "1rem" }} onClick={this.handleUpdate}><i class='far fa-edit' style={{ "color": "white" }}></i>Modifier</button>;
          ...
          <div className="jumbotron fluid">
            ...
            <div className="row align-items-center">
              ...
              <div className="col-sm-6 ">
                ...
                <div className="row">
                  <a className="col text-center" href={"https://linkcs.fr/user/" + this.state.data.author_login}><button className="btn btn-secondary w-50 h-100"  ><img src={logolinkcs} class="grey-img img-fluid" alt="Responsive image" /> LinkCS </button></a>
                  {buttonUpdate}
                  {buttonDelete}
                </div>
              </div>
